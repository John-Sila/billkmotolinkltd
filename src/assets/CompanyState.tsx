    ...
    <div className="no-user-found">
        <div className="card">
                ...
                <div className="content">
                    <span className="title">BILLK MOTOLINK LTD<span className="grayText">/Management</span></span>
                    <div className="desc">Sorry, company is currently paused.</div> 
